...
export default {
  name: "reservoirMasterFileManagement",
  mixins: [minxin],
  mounted() {
    this.getTable();
    this.getSelect();
  ...
  methods: {
    ...
    update() {
      ...
      this.form.title = "编辑库区";
      this.form.value = {
        code: data[0].code,
        areaName: data[0].reservoirAreaName,
