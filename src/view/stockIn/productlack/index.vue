...
export default {
  ...
  methods: {
    getTable() {
      ...
      this.formSearchData.value.StartShortAgeDate = timer ? timer[0] : "";
      this.formSearchData.value.EndShortAgeDate = timer ? timer[1] : "";
      this.get({
        url: StockIn.productLackPages,
        isLoading: true,
    ...
    export() {
      ...
      this.formSearchData.value.EndShortAgeDate = timer ? timer[1] : "";
      this.post({
        url: StockIn.productLackPagesExport,
        isLoading: true,
        responseType: "blob",
        data: Object.assign(this.formSearchData.value, {
          Page: this.paginations.page,
